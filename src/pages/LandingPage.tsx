...
const LandingPage = () => {
  return (
    <div className="relative">
      {/* Glass Spheres component as the main interactive element */}
      <div className="h-screen w-full overflow-hidden bg-black">
        <div className="scale-[1.0] md:block hidden">
          <GlassSpheres />
        </div>
        <div className="md:hidden flex flex-col items-center justify-center h-full px-4">
          <h1 className="font-montserrat font-bold text-4xl text-center mb-8 text-white">
